...
GLfloat position = 0.0f ,sk1,sk2,sk3;;
...
//    glPushMatrix();
//    glColor3ub(255, 98, 59);
//    glRotatef(180,-0.05,1,0);
//    glScalef(0.3,0.5,1);
